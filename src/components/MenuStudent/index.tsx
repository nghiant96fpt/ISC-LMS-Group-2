...
const Menu: React.FC = () => {
  ...
  return (
    <div className="relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      {/* Sidebar chính */}
      <div className="absolute left-0 top-0 bg-[#ff7506] w-[112px] sm:w-[112px] lg:w-28 h-screen">
        <div>
          <a href="/">
        ...
        <div className="w-8 h-[300px] left-[40px] top-[205px] absolute">
          ...
          <a
            href="#"
            className={`relative w-8 h-8 absolute top-[60px] left-0 flex justify-center items-center cursor-pointer ${
              activeIndex === 1
                ? 'before:content-[""] before:absolute before:w-[70px] before:h-[70px] before:bg-white/50 before:rounded-lg before:top-1/2 before:left-1/2 before:transform before:-translate-x-1/2 before:-translate-y-1/2'
                : ''
            }`}
          ...
          <a
            href="#"
            className={`relative w-8 h-8 absolute top-[120px] left-0 flex justify-center items-center cursor-pointer ${
              activeIndex === 2
                ? 'before:content-[""] before:absolute before:w-[70px] before:h-[70px] before:bg-white/50 before:rounded-lg before:top-1/2 before:left-1/2 before:transform before:-translate-x-1/2 before:-translate-y-1/2'
                : ''
            }`}
          ...
          <a
            href="#"
            className={`relative w-8 h-8 absolute top-[180px] left-0 flex justify-center items-center cursor-pointer ${
              activeIndex === 3
                ? 'before:content-[""] before:absolute before:w-[70px] before:h-[70px] before:bg-white/50 before:rounded-lg before:top-1/2 before:left-1/2 before:transform before:-translate-x-1/2 before:-translate-y-1/2'
                : ''
            }`}
          ...
          <a
            href="#"
            className={`relative w-8 h-8 absolute top-[240px] left-0 flex justify-center items-center cursor-pointer ${
              activeIndex === 4
                ? 'before:content-[""] before:absolute before:w-[70px] before:h-[70px] before:bg-white/50 before:rounded-lg before:top-1/2 before:left-1/2 before:transform before:-translate-x-1/2 before:-translate-y-1/2'
                : ''
            }`}
          ...
          <a
            href="#"
            className={`relative w-8 h-8 absolute top-[300px] left-0 flex justify-center items-center cursor-pointer ${
              activeIndex === 5
                ? 'before:content-[""] before:absolute before:w-[70px] before:h-[70px] before:bg-white/50 before:rounded-lg before:top-1/2 before:left-1/2 before:transform before:-translate-x-1/2 before:-translate-y-1/2'
                : ''
            }`}
      ...
      {isExpanded && (
        //   <div className="absolute left-0 top-0 bg-[#ff7506] w-full sm:w-[200px] lg:w-28 h-screen">
        <div className="w-[300px] h-screen left-[112px] top-0 absolute bg-white shadow-[4px_4px_10px_0px_rgba(133,178,220,0.25)]">
          <div
            className="w-2 h-14 left-[290px] top-[196px] absolute bg-[#ff7506] rounded-[11px]"
            style={{
              top: `${
                activeIndex === 0
                  ? '205px'
          ...
          <a
            href="#"
            className={`block w-full h-12 absolute no-underline flex items-center ${
              activeIndex === 0 ? 'text-[#ff7506]' : 'text-[#373839] opacity-70'
            }`}
            style={{ top: '205px', left: '34px' }}
          ...
          <a
            href="#"
            className={`block w-full h-12 absolute no-underline flex items-center ${
              activeIndex === 1 ? 'text-[#ff7506]' : 'text-[#373839] opacity-70'
            }`}
            style={{ top: '276px', left: '34px' }}
            onClick={() => setIsExpanded(false)}
          >
          ...
          <a
            href="#"
            className={`block w-full h-12 absolute no-underline flex items-center ${
              activeIndex === 2 ? 'text-[#ff7506]' : 'text-[#373839] opacity-70'
            }`}
            style={{ top: '436px', left: '34px' }}
            onClick={() => setIsExpanded(false)}
          >
            <i className="fa-solid fa-book text-lg"></i>
          ...
          <a
            href="#"
            className={`block w-full h-12 absolute no-underline flex items-center ${
              activeIndex === 3 ? 'text-[#ff7506]' : 'text-[#373839] opacity-70'
            }`}
            style={{ top: '598px', left: '34px' }}
            onClick={() => setIsExpanded(false)}
          >
          ...
          <a
            href="#"
            className={`block w-full h-12 absolute no-underline flex items-center ${
              activeIndex === 4 ? 'text-[#ff7506]' : 'text-[#373839] opacity-70'
            }`}
            style={{ top: '664px', left: '34px' }}
            onClick={() => setIsExpanded(false)}
          >
          ...
          <a
            href="#"
            className={`block w-full h-12 absolute no-underline flex items-center ${
              activeIndex === 5 ? 'text-[#ff7506]' : 'text-[#373839] opacity-70'
            }`}
            style={{ top: '730px', left: '34px' }}
            onClick={() => setIsExpanded(false)}
          >
          ...
          <a
            href="#"
            className="block w-full h-10 absolute no-underline flex items-center"
            style={{ top: '335px', left: '60px' }}
            onClick={() => setIsExpanded(false)}
          >
