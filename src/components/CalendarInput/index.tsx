...
import './style.css';
import iconColendar from '../../../src/assets/icons/icon-calendar.png';
import iconShapeRight from '../../../src/assets/icons/icon-arrow-right.png';
import iconShapeLeft from '../../../src/assets/icons/icon-arrow-left.png';
