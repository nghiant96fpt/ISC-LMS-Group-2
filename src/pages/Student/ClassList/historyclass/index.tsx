...
const HistoryClass: React.FC = () => {
    ...
    return (
        <div className="py-4">
            ...
            <div className="bg-background-white rounded-[16px] shadow-md w-full max-w-[1680px] mx-auto py-5">
                <div className="w-auto flex items-center gap-6 pl-[64px] pt-[24px] pb-[26px]">
                    <img
                        src={classScheduleData.avatar}
                        alt="Teacher"
                        ...
                        <div className="flex flex-col gap-3 text-left">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex gap-2 flex-1 w-2/3">
                                    ...
                                    <input
                                        type="time"
                                        className="border rounded p-2 text-gray-700 w-1/2 h-full"
                                        value={classScheduleData.endDate.time}
                                    />
                                </div>
                        ...
                        <div className="">
                            <div className="flex gap-4 whitespace-nowrap p-4 overflow-x-auto scrollbar-hide max-w-[1200px]">
                                {classScheduleData.sessions.slice(0, 7).map((session) => {
                                    ...
                                    if (session.status === "current") bgColor = "bg-orange-500";
                                    else if (session.status === "upcoming") bgColor = "bg-blue-500";

                                    return (
                                        <div key={session.id} className={`p-4 mx-2 rounded-lg text-center min-w-[120px] shadow-md text-white ${bgColor}`}>
                                            <p className="font-bold">Buổi {session.title}</p>
                    ...
                    <div className="max-w-3xl ml-[290px] p-4 rounded-md">
                        <div className="flex flex-col gap-2 text-left">
                            ...
                            <div className="flex items-center gap-x-4">
                                ...
                                <button className="bg-orange-500 text-white px-3 py-2 rounded flex-shrink-0">
                                    Copy link
                                </button>
                            </div>
