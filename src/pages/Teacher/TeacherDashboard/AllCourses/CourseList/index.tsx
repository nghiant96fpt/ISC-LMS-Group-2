        ...
        <div className="divide-y">
            {subjects.map((subject, index) => (
                <div
                    ...
                    <span className="px-4 py-3 font-bold text-black-text text-start text-xs md:text-sm lg:text-base">
                        {subject.title}
                    </span>
                    <span className="px-4 py-3 text-black-text text-start text-xs md:text-sm lg:text-base">
                        {subject.details.class}
                    </span>
                    <span className="px-4 py-3 text-black-text text-start text-xs md:text-sm lg:text-base">
                        {subject.details.schedule}
                    </span>
                    <span className="px-4 py-3 text-black-text text-start text-xs md:text-sm lg:text-base">
                        {subject.details.dateRange}
                    </span>
                    <span
