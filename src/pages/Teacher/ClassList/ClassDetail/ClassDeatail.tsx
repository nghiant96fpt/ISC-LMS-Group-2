                                            ...
                                            {isUpcoming && (
                                                <div className="mt-2 flex justify-center gap-2">
                                                    <button className={`w-8 h-8 flex items-center justify-center text-gray-300`} onClick={handleEdit.bind(null, session)}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="3232" fill="currentColor" className={`bi bi-pencil-square ${editSession?.id == session.id ? 'text-gray-400' : 'text-orange-500'}`} viewBox="0 0 16 16">
