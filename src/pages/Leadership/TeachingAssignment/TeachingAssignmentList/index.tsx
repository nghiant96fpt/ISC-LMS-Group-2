...
const TeachingAssignmentList = () => {
    ...
    const { data, page, pageSize, totalPages, loading, setPage, setPageSize } = useFetchTeachingAssignments();
    ...
    const confirmDelete = () => {
        if (selectedId) {
            deleteAssignment(Number(selectedId));
    ...
    return (
        <>
            ...
            <section className="rounded-lg bg-background-white shadow-[4px_4px_25px_4px_rgba(154,201,245,0.25)] sm:p-5 antialiased mb-10 ">
                ...
                <div className="mb-4 col-span-full xl:mb-2 min-h-[600px] overflow-auto">
