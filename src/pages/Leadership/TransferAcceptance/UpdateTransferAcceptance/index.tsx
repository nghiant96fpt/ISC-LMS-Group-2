...
const UpdateTransferAcceptance = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        // console.log('Dữ liệu API trả về:', res.data.data);
  ...
  //   axios
  //     .get(`https://fivefood.shop/api/address/wards?districtId=${districtId}`)
    ...
    <div className="w-full mx-auto bg-white rounded-lg shadow-md max-w-[800px] p-10 pb-2">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <select className="w-full md:w-[585px] p-2 bg-[#F2F2F2] rounded" onChange={(e) => handleProvinceChange(e.target.value)}>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <select
            className="w-full md:w-[585px] p-2 bg-[#F2F2F2] rounded"
