...
const AddTeacher = () => {
  ...
  const fetchDataSubject = async () => {
    try {
      const response = await axiosInstance.get('https://fivefood.shop/api/subjects'); // Thay YOUR_API_URL bằng URL thật của bạn
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="space-x-2 flex justify-between">
            <button className="border-r-[2px]" type="reset" title="Xóa">
            ...
            <Button className={`${isValid ? 'primary' : 'secondary'}`} type="submit" disabled={!isValid}>
