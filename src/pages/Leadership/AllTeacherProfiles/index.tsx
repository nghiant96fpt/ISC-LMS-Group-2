...
const mapStatusToType = (status: string) => {
    switch (status) {
        ...
        case "Đã nghỉ việc":
            return "dropped";
        case "Nghỉ hưu":
            return "classTransferred";
        case "Đã thôi học":
            return "dropped";
        default:
            return "studying"; // Mặc định nếu không khớp
    }
};
                        ...
                        <tbody>
                            {teachers.map((teacher, index) => (
                                <tr key={index} className={`border-b ${index % 2 === 1 ? 'bg-gray-100' : ''}`}>
                                    ...
                                    <td className="py-3 px-4 text-black-text ">{teacher.dob}</td>
                                    <td className="py-3 px-4 text-black-text ">{teacher.gender}</td>
                                    <td className="py-3 px-4 text-black-text ">{teacher.department}</td>
