...
const AddTrainingProgram: React.FC = () => {
  ...
  return (
    <div className="max-w-[884px] mx-auto mt-2 bg-white rounded-lg shadow-md px-[64px] pt-[24px] pb-[40px]">
            ...
            <div className="flex items-center">
              <div className="w-2/3 bg-gray-200 p-2 rounded flex items-center">
                ...
                <input
                  ...
                  disabled
                  className="flex-grow bg-gray-200 text-gray-500 border-none"
                />
              </div>

              <label
                htmlFor="fileInput"
                className={`w-1/3 ml-2 px-4 py-2 border border-orange-500 bg-orange-200 text-black-text cursor-pointer rounded ${
