      ...
      <div className="grid grid-cols-2 gap-2 mb-4 mt-9">
        ...
        <div className="col-span-1 flex justify-end gap-2 ml-10">
          <div className="flex mx-7">
            ...
            <Link to="/leadership/system-settings/school-info/edit">
              <Button className="primary" size="mini">
                Sửa
              </Button>
            </Link>
          </div>
      ...
      <div className="min-h-screen p-6">
        <div className=" mx-auto bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="col-span-2 grid grid-cols-2 gap-4 text-sm">
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between">
                    <p className="font-semibold">Tên trường:</p> <p>THCS Tự Lập</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Mã chuẩn:</p> <p>20202021</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Tỉnh/Thành phố:</p> <p>Tp. Hồ Chí Minh</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Xã/Phường:</p> <p>Phường 1</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Quận/Huyện:</p> <p>Bình Thạnh</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Trụ sở chính:</p> <p>Không</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Loại trường:</p> <p>Trung học cơ sở</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Số điện thoại:</p> <p>0123456789</p>
                  </div>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between">
                    <p className="font-semibold">Fax:</p> <p>09085677667</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Email:</p> <p>nguyenasjke@gmail.com</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Ngày thành lập:</p> <p>05/09/2013</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Mô hình đào tạo:</p> <p>Công lập</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Website:</p>{' '}
                    <a href="#" className="text-blue-600">
                      https://truongabc.com.vn
                    </a>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Hiệu trưởng:</p> <p>Bùi Văn Phát</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-semibold">Số hiệu trưởng:</p> <p>0989222112</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-orange-600 text-white font-semibold p-3 flex justify-between items-center">
            ...
            <div className="flex space-x-2 text-white mx-5">
              <Link to="/leadership/system-settings/school-info/edit" className="flex justify-center">
              ...
              <button className="hover:text-gray-300" onClick={() => setIsOpenDelete(true)}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
