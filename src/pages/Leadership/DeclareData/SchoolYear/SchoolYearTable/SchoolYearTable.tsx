...
const SchoolYearTable = ({ data, onDelete }: { data: ISchoolYear[]; onDelete: (id: number) => void }) => {
  return (
    <div className=" rounded-lg overflow-hidden">
      ...
      {/* tb body */}
      <div className="border border-gray-100 overflow-y-auto max-h-[250px] sm:max-h-[250px] md:max-h-[250px] lg:max-h-[270px] xl:max-h-[370px] custom-scrollbar">
          ...
          <tbody>
            {data.map((row, index) => (
              <tr key={row.id} className="text-center text-[16px] odd:background-white even:bg-[#f0f3f6]">
                ...
                <td className="lg:p-1.5">{row.year}</td>
