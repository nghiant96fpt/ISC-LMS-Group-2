  ...
  return (
    <div className="flex flex-col min-h-[752px]  bg-background-white shadow-custom rounded-lg p-4">
      ...
      <div className="overflow-x-auto flex-grow px-2 md:px-10">
        ...
        {isDeleteModalOpen && <DeleteModal title='Xóa' description='Xác nhận muốn xoá những thông tin đã chọn? Sau khi xoá sẽ không thể hoàn tác.' onCancel={handleCancelDelete} onConfirm={confirmDelete} />}
      </div>
