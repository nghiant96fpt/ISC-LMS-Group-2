...
const ManageExamSchedule: React.FC = () => {
  ...
  return (
    <div className="rounded-lg shadow-md bg-white mt-6">
      <div className="flex justify-between items-center">
        <h2 className="font-bold text-lg md:text-xl ml-8">Danh sách bài thi</h2>
        <div className="flex mb-4 justify-start">
          <div className="relative flex items-center w-full max-w-xs sm:w-[438px] rounded-[30px] border border-gray-300  p-1 ml-4">
      ...
      <div className="overflow-x-auto py-6 px-8">
        <table className="min-w-full border-collapse w-full overflow-hidden rounded-lg border-spacing-0">
          <thead className="bg-gradient-to-r from-background-orange-1 to-background-1 text-white rounded-t-lg">
            <tr>
              <th className="py-3 px-4 text-center whitespace-nowrap first:rounded-tl-lg last:rounded-tr-lg">
              ...
              <th className="py-3 px-4 text-ceter whitespace-nowrap ">
                <div className="flex items-center font-sans">
              ...
              <th className="py-3 px-4 text-ceter whitespace-nowrap whitespace-nowrap">
                <div className="flex items-center font-sans">
                  <span> </span>
                </div>
              </th>
              <th className="py-3 px-4 text-ceter whitespace-nowrap"></th>
            </tr>
          </thead>
          <tbody className="border-none">
            {examData.map((exam, index) => (
              <tr key={exam.id} className={`border-none hover:bg-gray-200 transition-all ${index % 2 !== 0 ? 'bg-gray-100' : 'bg-white'}`}>
                {' '}
                <td className="py-3 px-4 text-center border-none whitespace-nowrap">{exam.semester}</td>
                <td className="py-3 px-4 text-center border-none whitespace-nowrap">{exam.date}</td>
                <td className="py-3 px-4 text-center border-none whitespace-nowrap">{exam.grade}</td>
                <td className="py-3 px-4 text-center border-none whitespace-nowrap">{exam.subject}</td>
                <td className="py-3 px-4 text-center border-none whitespace-nowrap">{exam.examName}</td>
                <td className="py-3 px-4 text-center border-none whitespace-nowrap">{exam.status}</td>
                <td className="py-3 px-4 flex justify-center items-center text-center border-none">
                ...
                <td className="py-3 px-4 text-center border-none">{exam.teacher}</td>
                <td className="py-3 px-4 flex justify-center items-center text-center border-none">
      ...
      <div className="mt-auto flex flex-wrap justify-center md:justify-between items-center px-2 md:px-10 p-4 mb-5 text-black-text font-sans italic text-sm gap-2">
        ...
        <div className="flex space-x-1 md:space-x-2 items-center text-black-text text-sm font-sans">
          ...
          <button className="w-[26px] h-[26px] rounded-full bg-background-orange-1 text-white flex items-center justify-center font-medium">2</button>
